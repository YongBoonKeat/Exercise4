...
public class Main {
	...
	public static void main(String[] args) {
		...
		redApple objRA = new redApple("Red Apple",50,2.8,"Red","Sweet","China");
		System.out.println(objRA);
		
		//GreenApple
		System.out.println("========GREEN APPLE=======");
		greenApple objGA = new greenApple("Green Apple",120,3,"Light Green","Sour","Australia");
		...
		Mango objM = new Mango("Mango",20,3.5,10,200);
